...
import com.backend.dao.SysMenuDao;
...
public class SysMenuServiceImpl implements SysMenuService {
	...
	public List<SysMenuEntity> queryListByParentId(Long parentId, List<Long> menuIdList) {
		List<SysMenuEntity> menuList = sysMenuDao.queryListByParentId(parentId);
		if(menuIdList == null){
			return menuList;
		}
	...
	@Override
	public List<SysMenuEntity> queryUserPermsList(Long userId) {
		return sysMenuDao.queryUserPermsList(userId);
	}
